...
def add_certificate(certificate:Certificate,db: Session = Depends(get_db)):
    certificate=Certificates(certificate_issuer=certificate.certificate_issuer,certificate_name=certificate.certificate_name)
    db.add(certificate)
    db.commit()
...
def edit_certificate(certificate:Certificate,certificate_id:int,db: Session = Depends(get_db)):        
